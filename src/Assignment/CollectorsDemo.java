...
public class CollectorsDemo {
	...
	public static void main(String[] args) {
		...
		//Map<Boolean, List<Integer>> oddEven = numbers.stream().collect(Collectors.partitioningBy(num->num%2==0));
		
		Map<String, List<Integer>> oddEven = numbers.stream().collect(Collectors.groupingBy(num->num%2==0?"Even":"Odd"));
